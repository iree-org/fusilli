...
#       running in the fusilli docker container (described in fusilli README)
...
#
# USE_LOCAL
#   If set, uses local source from ../fusilli directory. Without USE_LOCAL,
...
macro(_fetch_Fusilli)
    ...
    message(STATUS "Using local Fusilli build from ../fusilli")
    FetchContent_Declare(
        Fusilli
        SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/../fusilli
    )
