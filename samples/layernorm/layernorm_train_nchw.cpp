...
TEST_CASE("Layer normalization; training mode; NCHW layout; no bias/scale",
          "[layernorm][graph]") {
  ...
  auto buildNewGraph = [=](const Handle &handle) {
    ...
    graph->setName("layernorm_train_sample_nchw");
  ...
  auto [graph, xT, yT, mT, vT] = buildNewGraph(handle);
