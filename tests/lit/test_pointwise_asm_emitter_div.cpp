...
// TORCH-CHECK:       %result = torch.aten.permute %result_pointwise_div_perm, %permute_OUT_0_pointwise_div : !torch.vtensor<[2,3,224,224],f32>, !torch.list<int> -> !torch.vtensor<[2,3,224,224],f32>
