...
static void testGetScalarConstantAsm() {
  ...
  // clang-format off
  // CHECK: %alpha_f32_test_perm = torch.vtensor.literal(dense<2.000000e+00> : tensor<1xf32>) : !torch.vtensor<[1],f32>
  // clang-format on
  std::cout << getScalarConstantAsm(floatScalar, "test") << std::endl;
  ...
  // clang-format off
  // CHECK: %alpha_f64_test_perm = torch.vtensor.literal(dense<3.140000e+00> : tensor<1xf64>) : !torch.vtensor<[1],f64>
  // clang-format on
  std::cout << getScalarConstantAsm(doubleScalar, "test") << std::endl;
  ...
  // clang-format off
  // CHECK: %alpha_i32_test_perm = torch.vtensor.literal(dense<42> : tensor<1xsi32>) : !torch.vtensor<[1],si32>
  // clang-format on
  std::cout << getScalarConstantAsm(int32Scalar, "test") << std::endl;
  ...
  // clang-format off
  // CHECK: %alpha_i64_test_perm = torch.vtensor.literal(dense<-7> : tensor<1xsi64>) : !torch.vtensor<[1],si64>
  // clang-format on
  std::cout << getScalarConstantAsm(int64Scalar, "test") << std::endl;
}
