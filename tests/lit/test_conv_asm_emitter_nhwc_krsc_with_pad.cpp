...
// TORCH-CHECK:       %arg1_filter_conv_fprop_perm = torch.aten.permute %arg1_filter, %permute_W_conv_fprop : !torch.vtensor<[256,3,3,128],f32>, !torch.list<int> -> !torch.vtensor<[256,128,3,3],f32>
...
static ErrorObject
testConvAsmEmitterXNhwcWKrscWithPad(const std::string &mode) {
