...
// TORCH-CHECK:       %result_perm = torch.aten.mul.Tensor %arg0_in0_pointwise_mul_perm, %arg1_in1_pointwise_mul_perm : !torch.vtensor<[2,3,128,128],f32>, !torch.vtensor<[128],f32> -> !torch.vtensor<[2,3,128,128],f32>
