...
// TORCH-CHECK:       %arg0_pointwise_sub_perm = torch.aten.permute %arg0, %permute_IN_0_pointwise_sub : !torch.vtensor<[3,16,16],f32>, !torch.list<int> -> !torch.vtensor<[3,16,16],f32>
...
// TORCH-CHECK:       %arg1_pointwise_sub_perm = torch.aten.permute %arg1, %permute_IN_1_pointwise_sub : !torch.vtensor<[3,1,1],f32>, !torch.list<int> -> !torch.vtensor<[3,1,1],f32>
// TORCH-CHECK:       %alpha_pointwise_sub = torch.constant.int 1
// TORCH-CHECK:       %result_pointwise_sub_perm = torch.aten.sub.Tensor %arg0_pointwise_sub_perm, %arg1_pointwise_sub_perm, %alpha_pointwise_sub : !torch.vtensor<[3,16,16],f32>, !torch.vtensor<[3,1,1],f32>, !torch.int -> !torch.vtensor<[3,16,16],f32>
...
// TORCH-CHECK:       %result = torch.aten.permute %result_pointwise_sub_perm, %permute_OUT_0_pointwise_sub : !torch.vtensor<[3,16,16],f32>, !torch.list<int> -> !torch.vtensor<[3,16,16],f32>
