...
// TORCH-CHECK:       %arg1_filter_conv_fprop_perm = torch.aten.permute %arg1_filter, %permute_W_conv_fprop : !torch.vtensor<[256,2,16,1,1],f32>, !torch.list<int> -> !torch.vtensor<[256,16,2,1,1],f32>
