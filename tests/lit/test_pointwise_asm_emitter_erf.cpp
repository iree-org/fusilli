...
// TORCH-CHECK:       %[[ERF:.+]] = torch.aten.erf %[[PERMUTE0]] : !torch.vtensor<[16,256,64,32],f32> -> !torch.vtensor<[16,256,64,32],f32>
...
// TORCH-CHECK:       %[[PERM_OUT:.+]] = torch.aten.permute %[[ERF]], %[[PERM_OUT_LIST]] : !torch.vtensor<[16,256,64,32],f32>, !torch.list<int> -> !torch.vtensor<[16,256,64,32],f32>
