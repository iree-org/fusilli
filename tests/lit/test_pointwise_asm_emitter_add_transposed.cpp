...
// TORCH-CHECK:       %arg0_input_pointwise_add_transposed_perm = torch.aten.permute %arg0_input, %permute_IN_0_pointwise_add_transposed : !torch.vtensor<[128,256],f32>, !torch.list<int> -> !torch.vtensor<[128,256],f32>
...
// TORCH-CHECK:       %arg1_add_transposed_pointwise_add_transposed_perm = torch.aten.permute %arg1_add_transposed, %permute_IN_1_pointwise_add_transposed : !torch.vtensor<[256,128],f32>, !torch.list<int> -> !torch.vtensor<[128,256],f32>
// TORCH-CHECK:       %alpha_pointwise_add_transposed = torch.constant.int 1
// TORCH-CHECK:       %result_pointwise_add_transposed_perm = torch.aten.add.Tensor %arg0_input_pointwise_add_transposed_perm, %arg1_add_transposed_pointwise_add_transposed_perm, %alpha_pointwise_add_transposed : !torch.vtensor<[128,256],f32>, !torch.vtensor<[128,256],f32>, !torch.int -> !torch.vtensor<[128,256],f32>
