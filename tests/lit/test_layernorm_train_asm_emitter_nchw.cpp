...
// TORCH-CHECK:       %layernorm_train_EPSILON = torch.vtensor.literal(dense<0x3727C5AC> : tensor<1xf32>) : !torch.vtensor<[1],f32>
...
// TORCH-CHECK:       %eps_layernorm_train = torch.aten.item %layernorm_train_EPSILON : !torch.vtensor<[1],f32> -> !torch.float
