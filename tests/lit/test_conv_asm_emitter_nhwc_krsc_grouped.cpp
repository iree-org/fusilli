...
// TORCH-CHECK:     func.func @main(%result_: !torch.tensor<[16,64,32,256],f32>, %arg0_image: !torch.vtensor<[16,64,32,128],f32>, %arg1_filter: !torch.vtensor<[256,16,1,1],f32>) attributes {torch.assume_strict_symbolic_shapes} {
...
// TORCH-CHECK:       %arg1_filter_conv_fprop_perm = torch.aten.permute %arg1_filter, %permute_W_conv_fprop : !torch.vtensor<[256,16,1,1],f32>, !torch.list<int> -> !torch.vtensor<[256,16,1,1],f32>
...
// TORCH-CHECK:       %result = torch.aten.permute %result_conv_fprop_perm, %permute_Y_conv_fprop : !torch.vtensor<[16,256,64,32],f32>, !torch.list<int> -> !torch.vtensor<[16,64,32,256],f32>
...
// LINALG-CHECK:      %[[BUF2E:.+]] = tensor.expand_shape %[[BUF2]] {{\[\[0, 1\], \[2\], \[3\], \[4\]\]}} output_shape [8, 32, 16, 1, 1] : tensor<256x16x1x1xf32> into tensor<8x32x16x1x1xf32>
