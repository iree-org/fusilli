...
// TORCH-CHECK:     func.func @main(%[[RESULT0:.+]]: !torch.tensor<[16,256,64,32],i1>, %[[ARG0:.+]]: !torch.vtensor<[16,256,64,32],f32>) attributes {torch.assume_strict_symbolic_shapes} {
...
// TORCH-CHECK:       %[[LOGICAL_NOT:.+]] = torch.aten.logical_not %[[PERMUTE0]] : !torch.vtensor<[16,256,64,32],f32> -> !torch.vtensor<[16,256,64,32],i1>
...
// TORCH-CHECK:       %[[PERM_OUT:.+]] = torch.aten.permute %[[LOGICAL_NOT]], %[[PERM_OUT_LIST]] : !torch.vtensor<[16,256,64,32],i1>, !torch.list<int> -> !torch.vtensor<[16,256,64,32],i1>
