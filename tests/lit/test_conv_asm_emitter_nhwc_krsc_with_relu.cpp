...
// TORCH-CHECK:       %conv_result_in0_pointwise_1_perm = torch.aten.permute %conv_result, %permute_IN_0_pointwise_1 : !torch.vtensor<[16,64,32,256],f32>, !torch.list<int> -> !torch.vtensor<[16,256,64,32],f32>
