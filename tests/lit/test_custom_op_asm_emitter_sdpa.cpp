...
// CHECK:           %q_sdpa_i0_dyn = torch.tensor_static_info_cast %q_sdpa_i0_perm : !torch.vtensor<[1,8,64,64],f16> to !torch.vtensor<[1,8,64,64],f16>
// CHECK:           %k_sdpa_i1_dyn = torch.tensor_static_info_cast %k_sdpa_i1_perm : !torch.vtensor<[1,8,64,64],f16> to !torch.vtensor<[1,8,64,64],f16>
// CHECK:           %v_sdpa_i2_dyn = torch.tensor_static_info_cast %v_sdpa_i2_perm : !torch.vtensor<[1,8,64,64],f16> to !torch.vtensor<[1,8,64,64],f16>
// CHECK:           %sdpa_OUT_0_sdpa_dyn = func.call @sdpa(%q_sdpa_i0_dyn, %k_sdpa_i1_dyn, %v_sdpa_i2_dyn) : (!torch.vtensor<[1,8,64,64],f16>, !torch.vtensor<[1,8,64,64],f16>, !torch.vtensor<[1,8,64,64],f16>) -> !torch.vtensor<[1,8,64,64],f16>
// CHECK:           %sdpa_OUT_0_sdpa_perm = torch.tensor_static_info_cast %sdpa_OUT_0_sdpa_dyn : !torch.vtensor<[1,8,64,64],f16> to !torch.vtensor<[1,8,64,64],f16>
