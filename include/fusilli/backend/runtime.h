...
//
// TODO(#15): Memoize `iree_runtime_call_t` initialization and
// populate buffer views at setup to avoid paying the penalty for every
// `Graph::execute` invocation. Use `iree_runtime_call_reset` to reset the call
